  ...
  <div>
    ...
    >
      ...
      <p class="has-text-centered">
        ...
        そのため、Youtubeにない動画は再生できません。また、ごちイラのサーバー上に音源は一切保管されていません。
    ...
    return {
      ...
      settings: [
        ...
        },
        {
          ...
          description: '再生するプレイリストのIDを指定します。デフォルトではDeyuii氏がまとめているごちうさ楽曲プレイリストを指定しています。リミックスリスト、削除された動画を含むプレイリストでは上手く動作しません。'
        },
        {
